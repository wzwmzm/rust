...
mod test {
    ...
    #[test]
    fn test_increase() {
        let mut test_struct = Test { a: 1, b: 2 };
        test_struct.increase();
        assert_eq!(test_struct.a, 2);
        assert_eq!(test_struct.b, 3);
    }
}
